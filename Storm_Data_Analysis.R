...
replacement_list <- list(
  ...
  c("HIGH SURF", "HEAVY SURF/HIGH SURF", "ASTRONOMICAL HIGH TIDE"),
  c("HIGH WIND", "HIGH WINDS", "WIND"),
  c("HURRICANE (TYPHOON)", "HURRICANE", "HURRICANE/TYPHOON"),
  c("ICE STORM"),
  c("LAKE-EFFECT SNOW"),
  c("LAKESHORE FLOOD"),
  c("LIGHTNING"),
  ...
  c("THUNDERSTORM WIND", "TSTM WIND/HAIL", "TSTM WIND", "THUNDERSTORM WINDS",
    ...
    "THUNDERTSORM WIND", "THUNDERSTORM WINDS/HAIL", "THUNDERSTORM"),
  c("TORNADO"),
